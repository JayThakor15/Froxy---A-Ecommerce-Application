...
class EmailService {
  ...
  generateInvoiceHTML(order) {
    ...
    return `
      ...
      <body>
        <div class="header">
          <div class="logo">Froxy</div>
          <div class="company-info">
            Your Trusted E-commerce Partner<br>
            Email: support@froxy.com | Phone: +1 (555) 123-4567
          </div>
        </div>
        ...
        <div class="footer">
          ...
          <p>For any questions about this invoice, please contact us at support@froxy.com</p>
  ...
  async sendOrderConfirmation(order) {
    try {
      ...
      const mailOptions = {
        ...
        html: this.generateEmailTemplate(order),
        attachments: [
          {
    ...
    return `
      ...
      <body>
        <div class="container">
          ...
          <div class="footer">
            <p>Thank you for choosing Froxy!</p>
            <p>If you have any questions, please contact us at support@froxy.com</p>
          </div>
        </div>
      </body>
      </html>
